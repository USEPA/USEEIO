...
api_df = f'aggregate_summary_imports_multipliers_{mrio}_{year}_{schema}.csv'
...
ta_df.to_csv(out_Path / f'TiVA_API_Comparison_{mrio}_{year}_{schema}.csv', index=False)
